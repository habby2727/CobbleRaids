...
public class MenuRewards {
  ...
  public MenuRewards() {
    ...
    this.damageRewards = new ItemModel("minecraft:iron_sword", "&cDamage Rewards");
    this.globalRewards = new ItemModel("minecraft:emerald", "&aGlobal Rewards");
    this.close = new ItemModel("minecraft:barrier", "&cClose");
    panels = new ArrayList<>();
    panels.add(new PanelsConfig(new ItemModel("minecraft:gray_stained_glass_pane"), 6));
  }
